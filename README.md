...
| Resource | Description |
|----------|-------------|
| [Big-O Cheat Sheet](https://www.bigocheatsheet.com/) | Quick-reference chart for time and space complexities of common data structures (Array, Stack, Queue, Linked List, BST, Hash Table) and sorting algorithms. Essential for exam prep, specifically Questions 18, 51, 67–70. |
...
| Category | Topic area (e.g. OOP, Data Structures, Algorithms) |
...
Below is a high-level map of unit topics:

- **OO Design** - Classes, encapsulation, inheritance, polymorphism, abstract classes
...
Contributions from current and former ICT283 students are welcome! If you have helpful notes, a well-explained concept, or a resource worth adding:
...
Please keep all contributions focused on learning. No full assessment solutions.
